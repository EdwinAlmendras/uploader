    ...
    try:
        ...
        async with UploadOrchestrator(
            ...
            if source.is_dir():
                ...
                process.on_progress(display.on_progress)
                ...
                process.on_hash_start(display.on_hash_start)
                process.on_hash_complete(display.on_hash_complete)
                process.on_sync_start(display.on_sync_start)
                process.on_sync_complete(display.on_sync_complete)
                process.on_check_complete(display.on_check_complete)
